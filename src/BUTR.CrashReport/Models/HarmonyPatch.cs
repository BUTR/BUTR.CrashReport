...
/// <summary>
/// <inheritdoc cref="HarmonyLib.Patch"/>
/// </summary>
public record HarmonyPatch
{
    /// <summary>
    ...
    /// <summary>
    /// <inheritdoc cref="HarmonyLib.Patch.PatchMethod"/>
    /// </summary>
    public required MethodInfo PatchMethod { get; set; }

    /// <summary>
    /// <inheritdoc cref="HarmonyLib.HarmonyPatchType"/>
    /// </summary>
