...
internal sealed record SourceFileSourceLinkResolved : SourceFile
{
    ...
    public SourceFileSourceLinkResolved(string filePath, string sourceCode) : base(SourceKind.SourceLinkResolved)
    {
        FilePath = filePath;
