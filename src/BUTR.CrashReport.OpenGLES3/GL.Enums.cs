...
partial class GL
{
    ...
    public enum BlendEquationMode : GLenum
    {
        FuncAdd = 0x8006,
        Min = 0x8007,
        Max = 0x8008,
    ...
    public enum BlendingFactorDest : GLenum
    {
        Zero = 0,
        SrcColor = 0x0300,
    ...
    public enum ShaderParameter : GLenum
    {
        ShaderType = 0x8B4F,
        DeleteStatus = 0x8B80,
    ...
    public enum ProgramParameter : GLenum
    {
    ...
    public enum ActiveAttribType : GLenum
    {
        Float = 0x1406,
        FloatVec2 = 0x8B50,
        FloatVec3 = 0x8B51,
    ...
    public enum ActiveUniformType : GLenum
    {
        Int = 0x1404,
        Float = 0x1406,
        FloatVec2 = 0x8B50,
    ...
    public enum BufferUsageHint : GLenum
    {
        StreamDraw = 0x88E0,
        StreamRead = 0x88E1,
        StreamCopy = 0x88E2,
    ...
    public enum PixelInternalFormat : GLint
    {
        DepthComponent = 0x1902,
        Alpha = 0x1906,
        Rgb = 0x1907,
    ...
    public enum TextureParameter : GLint
    {
        Nearest = 0x2600,
        Linear = 0x2601,
